...
\wdb{We are not consistent with UUs.  After the introduction of the acronym they should be UUs.  I am changing them as I find them.} \km{I have changed all cases, with the exception of the first usage in each new section.}
...
\km{there is a lot of repetition here between then two blue paragraphs.}

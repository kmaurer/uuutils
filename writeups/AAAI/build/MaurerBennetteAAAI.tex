...
\wdb{Unfortunately, as shown in Figure \ref{fig:coverutil}, the method of \citet{Bansal2018} consistently achieves lower utility than sequentially querying instances for which the classifier is most uncertain. 
